import { ArrowLeft, Droplets, Sparkles, Tags, Users } from "lucide-react";
...
const profileMetrics = [
  ["Intensidade", "intensity", Droplets],
  ["Doçura", "sweetness", Sparkles],
  ["Frescor", "freshness", Users],
  ["Elegância", "elegance", Tags],
  ["Sensualidade", "sensuality", Sparkles],
] as const;
    ...
    <article className={styles.page}>
      ...
      <header className={styles.hero}>
        ...
        <div className={styles.heroCopy}>
          ...
          <FitFragranceTitle className={styles.fragranceTitle}>{perfume.name}</FitFragranceTitle>
          ...
          <dl className={styles.essentialMeta} aria-label="Informações essenciais">
            ...
            <div className={styles.metaItem}>
              ...
              <dd>{perfume.categoryType ? categoryLabels[perfume.categoryType] ?? perfume.categoryType : "Não informado"}</dd>
            </div>
            <div className={styles.metaItem}>
              <dt>
            ...
            <div className={styles.metaItem}>
              ...
              <dd>{perfume.inspirationKind === "original" ? "Não se aplica" : perfume.inspiredBy}</dd>
            </div>
            ...
            <div className={styles.metaItemSecondary}>
              ...
              <dd>{perfume.audience ? audienceLabels[perfume.audience] ?? perfume.audience : "Não informado"}</dd>
            </div>
          </dl>
        </div>
      </header>
                ...
                return (
                  ...
                  >
                    ...
                    <span className={styles.performanceTrack} aria-hidden="true">
                      {value === null ? null : <span className={styles.performanceFill} style={{ width: `${value}%` }} />}
                    </span>
                  </li>
                );
              })}
